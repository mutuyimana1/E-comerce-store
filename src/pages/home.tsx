...
export default function Home() {
  ...
  const saleItems = products.filter((p) => p.discountPercentage > 10).slice(0, 8);
    ...
    <div className="py-6 space-y-16">
      ...
      <section className="space-y-4">
        <div className="flex justify-between items-end border-b border-zinc-100 pb-3">
          ...
          <Link to="/categories" className="text-xs font-medium text-black hover:underline">
            View All Categories →
          </Link>
        </div>
      ...
      <section className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-100 pb-3">
          ...
          <Link to="/products" className="text-xs font-medium text-black hover:underline">
            View All Products →
          </Link>
        </div>
